...
class WordFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.audioButton.setOnClickListener {
            toggleButtonIcon(binding.audioButton, R.drawable.play, R.drawable.pause)
        }
        binding.bookmarkWord.setOnClickListener {
            toggleButtonIcon(binding.bookmarkWord, R.drawable.bookmark_border, R.drawable.bookmark)
        }
